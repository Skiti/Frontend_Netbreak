...
.controller('registro_transazioni_ctrl', function($scope, $http, ServicesHost) {
	...
	$http.post(ServicesHost.transactions()+"retrieve_purchases_list_from_userid?Id="+localStorage.getItem("IdClient")).then(function(response) {
