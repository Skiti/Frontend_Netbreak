...
.controller('gestione_api_ctrl', function($scope, $http, $route, $mdDialog, ServicesHost) {
...
/*	$scope.servicesid = [];
	...
	$http.post(ServicesHost.microservices()+"retrieve_all_ms_info").then(function(response) {
	...
	$scope.disattivaAPI = function(IdMS) {
		$http.post(ServicesHost.microservices()+"change_isactive?IdMS=" + IdMS +"&IsActive=false").then(function(response) {
			if(response.data)
			{
				$route.reload();
			}
	...
	$scope.attivaAPI = function(IdMS) {
		$http.post(ServicesHost.microservices()+"change_isactive?IdMS=" + IdMS +"&IsActive=true").then(function(response) {
			if(response.data)
			{
				$route.reload();
			}
...
//	$scope.deleteAPI = function(IdMS) {
	function deleteAPI(IdMS){
		$http.post(ServicesHost.microservices()+"delete_ms?Id=" + IdMS).then(function(response) {
			if(response.data)
			{
				$route.reload();
			}
